                    ...
                    <div className="sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                        <div className="inline-block overflow-hidden align-middle border-b border-th-border shadow sm:rounded-lg">
                            <table className="table-auto">
                                <thead className="">
                                    <tr>
                                        <th className="px-24 py-3 border-b text-gray tracking-wider border-th-border bg-th-table-header-bg">
                                            Name
                                        </th>
                                        {quizzes.map(quiz => {
                                            return (
                                                <th key={quiz.id} className="px-6 py-3 text-xs font-medium leading-4 tracking-wider text-left text-gray uppercase border-b border-th-border bg-th-table-header-bg">
                                                    {quiz.name}
                                                </th>
                                            )
                                        })}
