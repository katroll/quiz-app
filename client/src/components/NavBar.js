            ...
            <div className="pt-4 pb-2 px-6">
                ...
                <div className="flex items-center">
                    ...
                    <div className="grow ml-3">
                        <p className="text-sm font-semibold text-blue-600">{`${user.first_name} ${user.last_name}`}</p>
                    </div>
                    <div className="grow ml-3">
                    ...
                    return (
                        <ul key={quiz.name} className="relative accordion-collapse collapse" id="collapseSidenavSecEx2" aria-labelledby="sidenavSecEx2" data-bs-parent="#sidenavSecExample">
                            <li className="relative">
                                <NavLink to={`/quiz/${quiz.name}`} className="flex items-center text-xs py-4 pl-12 pr-6 h-6 overflow-hidden text-gray-700 text-ellipsis whitespace-nowrap rounded hover:text-blue-600 hover:bg-blue-50 transition duration-300 ease-in-out">{quiz.name}</NavLink>
                            </li>
                        </ul>
                    )
                })}
