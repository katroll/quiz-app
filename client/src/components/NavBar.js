        ...
        <div className="w-60 h-full shadow-md bg-slate-500 absolute" id="sidenavSecExample">
                    ...
                    return (
                        <ul key={quiz.name} className="relative accordion-collapse collapse" id="collapseSidenavSecEx2" aria-labelledby="sidenavSecEx2" data-bs-parent="#sidenavSecExample">
                            <li class="relative" onClick={() => navigate(`/quiz/${quiz.name}`)}>
                                <a class="flex items-center text-sm font-semibold mx-5 py-4 px-6 h-12 overflow-hidden text-slate-800 text-ellipsis whitespace-nowrap rounded hover:text-slate-400 hover:bg-slate-800 transition duration-300 ease-in-out" href="#!" data-mdb-ripple="true" data-mdb-ripple-color="stone">
                                    <span>{quiz.name}</span>
                                </a>
                            </li>   
                        </ul>
            ...
            {!user.admin? (
                <ul class="relative px-1">
                    ...
                    <a class="flex items-center text-sm font-semibold py-4 px-6 h-12 overflow-hidden text-slate-800 text-ellipsis whitespace-nowrap rounded hover:text-slate-400 hover:bg-slate-800 transition duration-300 ease-in-out" href="#!" data-mdb-ripple="true" data-mdb-ripple-color="stone">
                        <span>Grades</span>
                    </a>
                    </li>
                </ul>
